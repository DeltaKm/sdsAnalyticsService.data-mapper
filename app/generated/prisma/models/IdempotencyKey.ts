...
export type IdempotencyKeyOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "key" | "createdAt", ExtArgs["result"]["idempotencyKey"]>
...
export interface IdempotencyKeyDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  /**
   * Find zero or more IdempotencyKeys that matches the filter.
   * @param {IdempotencyKeyFindRawArgs} args - Select which filters you would like to apply.
   * @example
   * const idempotencyKey = await prisma.idempotencyKey.findRaw({
   *   filter: { age: { $gt: 25 } }
   * })
   */
  findRaw(args?: Prisma.IdempotencyKeyFindRawArgs): Prisma.PrismaPromise<Prisma.JsonObject>

  /**
   * Perform aggregation operations on a IdempotencyKey.
   * @param {IdempotencyKeyAggregateRawArgs} args - Select which aggregations you would like to apply.
   * @example
   * const idempotencyKey = await prisma.idempotencyKey.aggregateRaw({
   *   pipeline: [
   ...
   * })
   */
  aggregateRaw(args?: Prisma.IdempotencyKeyAggregateRawArgs): Prisma.PrismaPromise<Prisma.JsonObject>
...
/**
 * IdempotencyKey findRaw
 */
export type IdempotencyKeyFindRawArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
...
/**
 * IdempotencyKey aggregateRaw
 */
export type IdempotencyKeyAggregateRawArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
